...
var DataSheet = (function (_PureComponent) {
  ...
  _createClass(DataSheet, [
    ...
    {
      key: 'getSelectedCellClasses',
      value: function getSelectedCellClasses(row, col) {
        var classes = '';

        // Get selected state of selection

        var _getState9 = this.getState(),
          _getState9$start = _getState9.start,
          iStart = _getState9$start.i,
          jStart = _getState9$start.j,
          _getState9$end = _getState9.end,
          iEnd = _getState9$end.i,
          jEnd = _getState9$end.j;

        // Get Equal matrix of selection

        var iFrom = iStart < iEnd ? iStart : iEnd;
        var iTo = iStart > iEnd ? iStart : iEnd;

        var jFrom = jStart < jEnd ? jStart : jEnd;
        var jTo = jStart > jEnd ? jStart : jEnd;
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props6 = this.props,
          ...
          isEnableBorderSelection = _props6.isEnableBorderSelection,
              ...
              return _react2.default.createElement(
                ...
                row.map(function (cell, j) {
                  ...
                  if (isEnableBorderSelection) {
                    selectedClasses += _this4.getSelectedCellClasses(i, j);
                  }
...
DataSheet.propTypes = {
  ...
  isEnableBorderSelection: _propTypes2.default.bool,
};
